...
<title>تقرير الورديات - مائدة الشام</title>
<style>
  @media print {
    @page {
      margin: 3mm 3mm;
  ...
  <div class="report-container compact">
    <div class="report-header compact">
      <div class="company-info compact">
        <div class="company-name single-line">مائدة الشام - تقرير الورديات</div>
      </div>
    ...
    <div class="report-footer compact">
      ...
      <div class="single-line spaced-text">مائدة الشام © ${toArabicNumbers(
